...
public class ControllerApplicativoTipoSegnalazione {
    ...
    public ControllerApplicativoTipoSegnalazione(BeanListeElementi bean, TypeOfPersistence persistence) throws NonEsistonoSegnalazioniException, SQLException, ErroreLetturaPasswordException {
