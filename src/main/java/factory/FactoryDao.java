...
public abstract class FactoryDao {
    ...
    public abstract EntitaFerroviariaDao useDao(TypeOfPersistence typeOfPersistence, TypeEntita typeEntita) throws SQLException, ErroreLetturaPasswordException;
