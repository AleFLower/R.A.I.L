        ...
        registratiAlSistemaButton.setOnMouseClicked(event->{
            ...
            if(textFieldUsername.getText().equals("")||textFieldEmail.getText().equals("")||passwordFieldPassword.getText().equals("")){
                ...
                if (controlliSintatticiEmail == null) {
                    ...
                    try{
                        ControllerApplicativoRegistrazioneAlSistema controllerApplicativoRegistrazioneAlSistema=new ControllerApplicativoRegistrazioneAlSistema(beanRegistrazione, UtilityAccesso.getPersistence());
